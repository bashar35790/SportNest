  ...
  return (
    <section className="mx-auto  px-5 py-20 sm:px-8 lg:px-14 relative isolate overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto rounded-[32px] border border-white/10 bg-slate-950">
        ...
        {/* Content */}
        <div className="relative z-10 flex min-h-[500px] flex-col items-center justify-center px-6 text-center sm:px-10">
          {/* Badge */}
          ...
          {/* Heading */}
          <h2 className="max-w-4xl text-4xl font-light leading-[1.1] tracking-tight text-white sm:text-5xl lg:text-7xl">
            Ready to <span className="italic text-cyan-400">Level Up</span> Your
            Game?
          </h2>
